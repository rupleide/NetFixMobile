...
pub const WS_WRITE_TIMEOUT: Duration = Duration::from_secs(30);
pub const WS_CONTROL_TIMEOUT: Duration = Duration::from_secs(10);
pub const WS_BRIDGE_CHUNK_SIZE: usize = 16 * 1024;
